...
void USettingRowWidget_PostProcessingQuality::UpdateSettingValue(bool bOverrideValue)
{
	...
	{
	case 0:
		PostProcessingQualityText = FText(LOCTEXT("Settings.PostProcessingQuality.Low", "低"));
		break;
	case 1:
		PostProcessingQualityText = FText(LOCTEXT("Settings.PostProcessingQuality.Medium", "中"));
		break;
	case 2:
		PostProcessingQualityText = FText(LOCTEXT("Settings.PostProcessingQuality.High", "高"));
		break;
	case 3:
		PostProcessingQualityText = FText(LOCTEXT("Settings.PostProcessingQuality.Epic", "极高"));
		break;
	case 4:
		PostProcessingQualityText = FText(LOCTEXT("Settings.PostProcessingQuality.Cinematic", "电影级"));
		break;
	default:
		PostProcessingQualityText = FText::FromString("未定义");
		break;
	}
