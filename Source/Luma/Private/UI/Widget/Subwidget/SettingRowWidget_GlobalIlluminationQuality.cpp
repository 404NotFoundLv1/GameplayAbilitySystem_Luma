...
void USettingRowWidget_GlobalIlluminationQuality::UpdateSettingValue(bool bOverrideValue)
{
	...
	{
	case -1:
		GlobalIlluminationQualityText = FText(LOCTEXT("Settings.GlobalIlluminationQuality.Disabled", "关闭"));
		break;
	case 0:
		GlobalIlluminationQualityText = FText(LOCTEXT("Settings.GlobalIlluminationQuality.Low", "低"));
		break;
	case 1:
		GlobalIlluminationQualityText = FText(LOCTEXT("Settings.GlobalIlluminationQuality.Medium", "中"));
		break;
	case 2:
		GlobalIlluminationQualityText = FText(LOCTEXT("Settings.GlobalIlluminationQuality.High", "高"));
		break;
	case 3:
		GlobalIlluminationQualityText = FText(LOCTEXT("Settings.GlobalIlluminationQuality.Epic", "极高"));
		break;
	case 4:
		GlobalIlluminationQualityText = FText(LOCTEXT("Settings.GlobalIlluminationQuality.Cinematic", "电影级"));
		break;
	default:
		GlobalIlluminationQualityText = FText::FromString("未定义");
		break;
	}
